...
$sql = "SELECT nomor_peserta, nama, kelas, ruang
        FROM peserta
        WHERE ruang = ?";
$params = [$ruang];
...
<head>
<meta charset="utf-8">
<title>Daftar Hadir - Ruang <?= e($ruang) ?></title>
<style>
...
<div class="toolbar no-print">
  <div><strong>Daftar Hadir - Ruang <?= e($ruang) ?></strong></div>
...
<div class="rekap">
  <div>Jumlah Siswa Seharusnya : <?= $jumlahSeharusnya ?> Siswa</div>
  <div>Tidak Hadir : ...............</div>
